...
describe('Arguments', function() {
  it('should not accept too few arguments', function() {
    expect(function() {
      autostart.enableAutostart('someString', 'anotherString', 'stillAString');
    }).to.throw(Error);
    expect(function() {
      autostart.disableAutostart('someString');
    }).to.throw(Error);
    expect(function() {
      autostart.isAutostartEnabled('someString');
    }).to.throw(Error);
  });

  it('should not accept arguments with wrong types', function() {
    expect(function() {
      autostart.enableAutostart(1, 2, 3, 4);
    }).to.throw(Error);
    expect(function() {
      autostart.enableAutostart('string', 2, 3, 4);
    }).to.throw(Error);
    expect(function() {
      autostart.enableAutostart('string', 'string', 3, 4);
    }).to.throw(Error);
    expect(function() {
      autostart.enableAutostart('string', 'string', 'string', 4);
    }).to.throw(Error);
    expect(function() {
      autostart.disableAutostart(1, 2);
    }).to.throw(Error);
    expect(function() {
      autostart.disableAutostart('string', 2);
    }).to.throw(Error);
    expect(function() {
      autostart.isAutostartEnabled(1, 2);
    }).to.throw(Error);
    expect(function() {
      autostart.isAutostartEnabled('string', 2);
    }).to.throw(Error);
  });
});
